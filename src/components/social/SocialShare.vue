	...
	<div class="flex justify-center bg-white" id="share">
		<div class="flex flex-wrap items-center my-auto">
			<div class="relative ml-24">
				<button
					class="relative flex sharebtn hover:opacity-100 focus:outline-none focus:border-blue-400"
					title="click to enable menu"
				>
					<svg class="w-5 h-5 md:w-6 md:h-6 svg-icon" viewBox="0 0 20 20">
						<path
					...
					<span class="inline-block pr-4 text-sm text-gray-800 md:text-base">Compartilhar</span>
				</button>
				...
				>
					<ShareNetwork
						network="facebook"
						:url="`https://blog-terceiraidade.netlify.app/?post=${id}`"
						:title="title"
						:description="title"
						:quote="title"
					>
						<div class="flex px-4 py-2 text-sm text-gray-800 border-b hover:bg-blue-100">
							<svg
								aria-hidden="true"
								focusable="false"
								data-prefix="fab"
					...
					>
						<div class="flex px-4 py-2 text-sm text-gray-800 border-b hover:bg-blue-100">
							<svg
								class="w-5 h-5 mr-4 overflow-hidden bg-green-400 rounded-full"
								xmlns="http://www.w3.org/2000/svg"
